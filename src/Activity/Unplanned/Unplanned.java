 ...
 */
public class Unplanned extends Activity implements ActivityInterface{

    public Unplanned(Site site, UnplannedBuilder.Typology typology, String description, int week, int estimatedTime, boolean assigned, Materials materials, Competences competences, Procedure procedure) {
