...
public class ActivitySelection extends javax.swing.JFrame {
        ...
        if(weeks==null)
            ...
            for(Activity a: activities.getActivities().values()){
                if(a.getWeek()==Integer.valueOf(answer)){
                    Object []o={a.getActivityID(), a.getSite(), a.getTypology(), a.getEstimatedTime()};
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        P1_1_JFrame frame = new P1_1_JFrame(planner.getUsername(), planner.getPassword());
        frame.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        comp.insertCompetence(new Competence("Idraulica"));
        Materials mat  = new Materials();
        mat.insertMaterial(new Material("tubo"));
         
        ActivityBuilder builder = new PlannedBuilder();
        Activity p1 = builder.setSite("Fisciano", "Ditta1")
        ...
        Activity p2 = builder.setSite("Solofra", "Ditta2")
                            ...
                            .setCompetences(comp)
                            .getActivity(); 
        Activity p3 = builder.setSite("Solofra", "Ditta2")
                            .setTypology(PlannedBuilder.Typology.Hydraulic)
                            .setDescription("Manutenzione generale")
                            .setWeek(1)
                            .setEstimatedTime(60)
